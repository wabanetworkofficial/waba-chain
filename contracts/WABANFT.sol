...
contract WABANFT is ERC721EnumerableUpgradeable, OwnableUpgradeable {
    using StringsUpgradeable for uint256;
    ...
    function buy(bytes memory signature) external payable {
        ...
        // require(!sigUsed[signature], "signature is claimed");
        sigUsed[signature] = true;
        refundIfOver(priceETH);
    ...
    function setSigner(address signer_, bool b_) public onlyOwner {
        signers[signer_] = b_;
    }
}
